...
const defaultTourData: TourDataType = {
  title: "Tour Package",
...
export default function TourPage({
  ...
  const [tourData, setTourData] = useState<TourDataType>(defaultTourData);
    ...
    fetch(`https://x8ki-letl-twmt.n7.xano.io/api:qNrTfAaz/package/${packageId}`)
      ...
      .then((data: Package) => {
        setTourData({
          ...
          location: data.departure_city || "Destination",
        ...
        <div className="flex flex-wrap items-center gap-6 border-b border-gray-200">
          ...
          <div className="flex gap-6 ml-auto flex-wrap">
            {[
              ...
              { icon: <MdOutlineMan />, label: "Min Age", sub: String(tourData.minAge) },
            ].map((item, i) => (
          ...
          <div className="flex-1 min-w-0">
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-500 text-sm mb-5">
                To help you plan your trip, we have put together a list of whats
                included and whats not included in your tour package.
              </p>
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-500 text-sm mb-4">
                This comprehensive map is designed to guide you through an exciting
                journey filled with remarkable destinations and captivating
                experiences.
              </p>
                ...
                {tourData.itinerary.map((item) => (
                  ...
                  >
                    <span className="text-sm font-medium">
                      <span className="text-teal-500 font-semibold mr-2">
                        DAY {item.day} •
                      </span>
                      {item.title}
                    </span>
